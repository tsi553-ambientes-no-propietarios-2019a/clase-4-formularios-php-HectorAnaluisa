...
<html>
  <head>
    <meta charset="utf-8">
    <title>Dime el día :)</title>
  </head>
  <body>

    <form method = "POST">
        <div>
        <h2> INGRESE UN NUMERO ENTRE 1 y 365 que corresponden a los dias del año</h2>
        </div>
        <div>
        Dime el numero de día a buscar: <input type= "number" name = "numeroBusqueda">
        </div>     
        <div>
